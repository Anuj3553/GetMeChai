...
const Login = () => {
    ...
    useEffect(() => {
        document.title = "Login - GetMeChai"
        if (session) {
        ...
        <div className='text-white'>
            ...
            <div className="flex flex-col gap-2 min-h-screen items-center p-10">
                ...
                <button onClick={() => { signIn("google") }}
                    className="flex items-center w-64 bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                ...
                <button
                    className="flex items-center w-64 bg-gray-400 border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 disabled:cursor-not-allowed" disabled>
                    <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
